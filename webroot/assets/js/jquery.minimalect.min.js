...
(function (e, t, n, r) {
    ...
    o.prototype = {
        init: function () {
            ...
            this.wrapper.append('<input type="text" value="" placeholder="' + (this.element.find("option[selected]").html() || this.options.placeholder) + '" />');
